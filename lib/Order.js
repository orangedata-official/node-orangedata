...
class Order {
  constructor(order) {
    ...
    this.content = {
      ...
      settlementAddres: order.settlementAddres,
      settlementPlace: order.settlementPlace,
    };
  }

  addPosition({ quantity, price, tax, text, paymentMethodType, paymentSubjectType, nomenclatureCode }) {
    this.content.positions.push(
      { quantity, price, tax, text, paymentMethodType, paymentSubjectType, nomenclatureCode },
    );
    return this;
  }
