...
const position = createValidator({
  ...
  agentInfo: createValidator({
    ...
    paymentOperatorPhoneNumbers: [arrayOf([internationalPhone])],
    paymentAgentPhoneNumbers: [arrayOf([internationalPhone])],
    paymentTransferOperatorPhoneNumbers: [arrayOf([internationalPhone])],
  }),
  taxSum: [decimal(2)],
